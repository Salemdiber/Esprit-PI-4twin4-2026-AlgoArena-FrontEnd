    ...
    return (
        <header style={{ background: 'var(--color-bg-secondary)', borderBottom: '1px solid var(--color-border)', transition: 'background-color 0.3s ease, border-color 0.3s ease' }} className="sticky top-0 z-20 shadow-custom">
            <div className="flex items-center justify-between px-6 py-4">
                ...
                {/* Mobile Toggle */}
                <button type="button" aria-label={t('topNav.toggleMenu')} className="lg:hidden p-2 rounded-lg transition-all spotlight-hover" style={{ color: 'var(--color-text-secondary)' }} onClick={onToggleSidebar}>
                        ...
                        >
                            <div className="profile-dropdown-header" style={{ padding: '16px', borderBottom: '1px solid var(--color-border-subtle)' }}>
                                <div className="flex items-center justify-between">
                                    ...
                                    <span style={{ fontSize: '10px', color: 'var(--color-cyan-500)', fontWeight: 'bold', background: 'var(--color-info-bg)', padding: '2px 6px', borderRadius: '4px' }}>{t('topNav.newBadge', { count: 2 })}</span>
                                </div>
                            </div>
                            ...
                            <div style={{ overflowY: 'auto', flex: 1 }}>
                                ...
                                <div className="profile-dropdown-item" style={{ padding: '12px 16px', borderBottom: '1px solid var(--color-border-subtle)', alignItems: 'flex-start', cursor: 'pointer' }}>
                                    ...
                                    <div className="ml-3">
                                        <p style={{ color: 'var(--color-text-primary)', fontSize: '14px', fontWeight: '500' }}>{t('topNav.notifSystemUpdate')}</p>
                                        <p style={{ color: 'var(--color-text-muted)', fontSize: '12px', marginTop: '2px', lineHeight: '1.4' }}>{t('topNav.notifSystemUpdateBody')}</p>
                                        <p style={{ color: 'var(--color-text-muted)', fontSize: '10px', marginTop: '4px' }}>{t('topNav.justNow')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="profile-dropdown-item" style={{ padding: '12px 16px', borderBottom: '1px solid var(--color-border-subtle)', alignItems: 'flex-start', cursor: 'pointer' }}>
                                    ...
                                    <div className="ml-3">
                                        <p style={{ color: 'var(--color-text-primary)', fontSize: '14px', fontWeight: '500' }}>{t('topNav.notifServerAlert')}</p>
                                        <p style={{ color: 'var(--color-text-muted)', fontSize: '12px', marginTop: '2px', lineHeight: '1.4' }}>{t('topNav.notifServerAlertBody')}</p>
                                        <p style={{ color: 'var(--color-text-muted)', fontSize: '10px', marginTop: '4px' }}>{t('topNav.minsAgo', { n: 42 })}</p>
                                    </div>
                                </div>
                                ...
                                <div className="profile-dropdown-item" style={{ padding: '12px 16px', alignItems: 'flex-start', cursor: 'pointer', opacity: 0.7 }}>
                                    ...
                                    <div className="ml-3">
                                        <p style={{ color: 'var(--color-text-primary)', fontSize: '14px', fontWeight: '500' }}>{t('topNav.notifNewUser')}</p>
                                        <p style={{ color: 'var(--color-text-muted)', fontSize: '12px', marginTop: '2px', lineHeight: '1.4' }}>{t('topNav.notifNewUserBody')}</p>
                                        <p style={{ color: 'var(--color-text-muted)', fontSize: '10px', marginTop: '4px' }}>{t('topNav.hoursAgo', { n: 2 })}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="profile-dropdown-header">
                                <div className="flex items-center gap-3 overflow-hidden">
                                    ...
                                    <div className="flex-1 overflow-hidden">
                                        <p className="font-semibold truncate" style={{ color: 'var(--color-text-primary)' }}>{currentUser?.username || t('sidebar.adminUser')}</p>
