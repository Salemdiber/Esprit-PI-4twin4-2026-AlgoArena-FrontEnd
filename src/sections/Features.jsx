...
// Steps will be created inside the component to use translations
const getSteps = (t) => [
    {
        title: t('landing.write_logic'),
        desc: t('landing.write_desc'),
        icon: (
            <path
                strokeLinecap="round"
    ...
    {
        title: t('landing.execute_simulate'),
        desc: t('landing.execute_desc'),
        icon: (
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
    ...
    {
        title: t('landing.compete_climb'),
        desc: t('landing.compete_desc'),
        icon: (
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
...
const getFeatures = (t) => [
    {
        title: t('landing.real_time_battles'),
        desc: t('landing.battle_desc'),
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
        )
    },
    {
        title: t('landing.visual_simulations'),
        desc: t('landing.visual_desc'),
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
        )
    },
    {
        title: t('landing.performance'),
        desc: t('landing.perf_desc'),
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
        )
    },
    {
        title: t('landing.curated'),
        desc: t('landing.curated_desc'),
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
        )
    },
    {
        title: t('landing.global_leaderboards'),
        desc: t('landing.global_desc'),
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
        )
    },
    {
        title: t('landing.secure_sandbox'),
