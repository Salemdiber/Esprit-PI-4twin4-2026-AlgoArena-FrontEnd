...
const ACTION_META = {
    ...
    COMMUNITY_POST_CREATED: createActionMeta(FilePlus, 'admin.activityLogs.communityPostCreated', 'blue', 'community'),
    COMMUNITY_POST_UPDATED: createActionMeta(Pencil, 'admin.activityLogs.communityPostUpdated', 'blue', 'community'),
    COMMUNITY_POST_DELETED: createActionMeta(Trash2, 'admin.activityLogs.communityPostDeleted', 'red', 'community'),
    COMMUNITY_POST_SOLVED_TOGGLED: createActionMeta(BadgeCheck, 'admin.activityLogs.communityPostSolvedToggled', 'green', 'community'),
    COMMUNITY_POST_PINNED_TOGGLED: createActionMeta(Flag, 'admin.activityLogs.communityPostPinnedToggled', 'amber', 'community'),
    COMMUNITY_COMMENT_ADDED: createActionMeta(MessageCircle, 'admin.activityLogs.communityCommentAdded', 'blue', 'community'),
    COMMUNITY_COMMENT_UPDATED: createActionMeta(Pencil, 'admin.activityLogs.communityCommentUpdated', 'blue', 'community'),
    COMMUNITY_COMMENT_DELETED: createActionMeta(Trash2, 'admin.activityLogs.communityCommentDeleted', 'red', 'community'),
    COMMUNITY_COMMENT_PINNED_TOGGLED: createActionMeta(Flag, 'admin.activityLogs.communityCommentPinnedToggled', 'amber', 'community'),
    COMMUNITY_MEDIA_UPLOADED: createActionMeta(Activity, 'admin.activityLogs.communityMediaUploaded', 'purple', 'community'),
...
const ENTITY_FILTERS = [
    ...
    { value: 'community', label: 'admin.activityLogs.entityCommunity' },
