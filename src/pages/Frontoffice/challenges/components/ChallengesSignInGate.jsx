  ...
  return (
    <Box
      ...
      bgImage={useColorModeValue(
        'radial-gradient(circle at 14% 18%, rgba(34, 211, 238, 0.08), transparent 24%), radial-gradient(circle at 88% 14%, rgba(59, 130, 246, 0.08), transparent 22%)',
        'radial-gradient(circle at 14% 18%, rgba(34, 211, 238, 0.16), transparent 24%), radial-gradient(circle at 88% 14%, rgba(59, 130, 246, 0.16), transparent 22%), radial-gradient(circle at 80% 82%, rgba(14, 165, 233, 0.16), transparent 26%)'
      )}
      position="relative"
      overflow="hidden"
    >
      ...
      >
        ...
        >
          ...
          >
            {[
              { label: t('appGuards.challenges.statPractice'), value: t('appGuards.challenges.statPracticeVal'), icon: '🎯' },
              { label: t('appGuards.challenges.statTime'), value: t('appGuards.challenges.statTimeVal'), icon: '⚡' },
              { label: t('appGuards.challenges.statRank'), value: t('appGuards.challenges.statRankVal'), icon: '🏆' },
            ].map((item) => (
              <Box
                key={item.label}
                p={5}
        ...
        >
          ...
          <Box display="grid" gridTemplateColumns="1fr" gap={4}>
            {[
              { title: t('appGuards.challenges.card1Title'), detail: t('appGuards.challenges.card1Detail'), tone: useColorModeValue('blue.50', 'rgba(59, 130, 246, 0.14)') },
              { title: t('appGuards.challenges.card2Title'), detail: t('appGuards.challenges.card2Detail'), tone: useColorModeValue('sky.50', 'rgba(14, 165, 233, 0.14)') },
              { title: t('appGuards.challenges.card3Title'), detail: t('appGuards.challenges.card3Detail'), tone: useColorModeValue('cyan.50', 'rgba(34, 211, 238, 0.14)') },
            ].map((card) => (
              <Box
                key={card.title}
                p={5}
