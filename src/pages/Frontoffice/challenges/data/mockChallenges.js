...
export const RANK_META = {
    [Rank.BRONZE]: { label: 'Bronze', title: 'Novice', gradient: ['#A85E34', '#78350F'], xpCeil: 1500, color: '#B45F06' },
    [Rank.SILVER]: { label: 'Silver', title: 'Apprentice', gradient: ['#94A3B8', '#475569'], xpCeil: 3000, color: '#64748B' },
    [Rank.GOLD]: { label: 'Gold', title: 'Coder', gradient: ['#FACC15', '#B45309'], xpCeil: 5000, color: '#D97706' },
    [Rank.PLATINUM]: { label: 'Platinum', title: 'Developer', gradient: ['#22D3EE', '#0891B2'], xpCeil: 10000, color: '#06B6D4' },
    [Rank.DIAMOND]: { label: 'Diamond', title: 'Engineer', gradient: ['#38BDF8', '#1D4ED8'], xpCeil: 15000, color: '#0EA5E9' },
    [Rank.RUBY]: { label: 'Ruby', title: 'Architect', gradient: ['#FB7185', '#9F1239'], xpCeil: 25000, color: '#E11D48' },
    [Rank.EMERALD]: { label: 'Emerald', title: 'Master', gradient: ['#34D399', '#065F46'], xpCeil: 40000, color: '#10B981' },
    [Rank.SAPPHIRE]: { label: 'Sapphire', title: 'Grandmaster', gradient: ['#60A5FA', '#1E40AF'], xpCeil: 60000, color: '#2563EB' },
    [Rank.OBSIDIAN]: { label: 'Obsidian', title: 'Legend', gradient: ['#4B5563', '#111827'], xpCeil: 100000, color: '#1F2937' },
    [Rank.CHAMPION]: { label: 'AlgoArena Champion', title: 'Champion', gradient: ['#FACC15', '#7C3AED'], xpCeil: 100000, color: '#8B5CF6' },
};
